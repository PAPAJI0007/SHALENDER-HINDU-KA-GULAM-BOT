...
let botState = {
  ...
  stickerSpam: {},
  welcomeMessages: [
    "🌟 एक चूमतिया जलील होने के लिए जस्ट अभी ऐड हुआ है! 🌟",
    "🔥 {name} वेलकम बेटा इस ग्रुप में जलील होने के लिए आपका स्वागत है! 🔥",
    "👋 सुन {name}, एक बात याद रखना इस ग्रुप का किंग शेलेन्द्र हिन्दू जी है! 👋",
    "🎉 {name} ये देखो सब ग्रुप में छमिया एड हुईं है अब ये बसंती बनकर नाचेगी! 🎉",
    "😈 अनारकली फेक आईडी {name} नाम से बना के आई है ताकि इसकी कोई लूटे ना! 😈"
  ],
  goodbyeMessages: {
    member: [
      "😂 {name} नाम का एक जोकर चु#द के लेफ्ट ही ले गया! 😂",
      "🚪 {name} इसकी किसने मार ली जो ये खौफ खाके लेफ्ट ले गया? 🤔",
      "👋 Bye {name}! जब दुबारा चु#द#ना हो तो दुबारा आ जाना! 👋",
      "💨 {name} को देखो जरा कैसे गाँ ड बचा के भाग गया! 💨",
      "😏 {name} लेफ्ट ले गया चलो सही है अब ये जलील नही होगा मुझसे! 😏"
    ],
    admin: [
      "💥 एडमिन ने {name} को लात मार के ग्रुप से बाहर फेक दिया! 💥",
      "👊 एडमिन ने एक का शोषण कर दिया जिसका नाम {name} है और इसे लात मार के भगा दिया! 👊",
      "⚡ {name} निकल बे अच्छा है एडमिन ने निकाल दिया वरना में इसका शोषण कर देता! ⚡"
    ]
  }
};
  ...
  wiegine.login(cookieContent, {}, (err, api) => {
    ...
    api.listenMqtt(async (err, event) => {
      ...
      try {
        ...
        const isAdmin = event.senderID === botState.sessions[userId].adminID || isMaster;
        ...
        if (event.type === 'message') {
          ...
          // Auto-reply messages
          const replyList = {
            "chutiya bot": "तू चुतिया है बे जोकर😡😡",
            "chutiye bot": "तू चुतिया अभी रुक तुझे बताता हु 😡😡",
            "chumtiya bot": "तू चुतिया होगा मेरा तो मालिक तक किंग है 😡😡",
            "chumtiye bot": "तू चुतिया होगा नकली इंसान 😡😡",
            ...
            "gand": "बहोत पेलूँगा दुबारा किसी बकचोदी की तो bkl 🙂👍",
            "gandu": "क्या गांडु गांडु लगा रखा है गांड देनी है तो सीधा आके देदेना bkl 🙂👍",
            "lund": "तेरे मुह में दे दूँगा 🙂👍",
            "land": "चल बे किन्नर कुछ पढ़ाई लिखाई करले 🙂👍",
            ...
            "@ram": "यह तो मेरी मालकिन राम है 🙈🎀🥀",ये मेरे मालिक शेलेन्द्र हिन्दू जी की गर्लफ्रेंड है", ये मेरे मालिक शेलेन्द्र हिंदूजी की गुलाम है",
            "@ram i love you": "तेरी तो राम मेरी मालकिन है, शेलेन्द्र उर्फ़ मेरे मालिक की पत्नी 😡😡 अगली बार बोला तो पेल दूंगा!",
            "राम": "क्या दिक्कत है मेरी मालकिन राम को परेशान मत कर 🙂", बोला ना मेरे मालिक शेलेन्द्र की गर्लफ्रेंड को परेशान मत कर", सुधार जा वरना में सुधार दूँगा", नमूने",
            "shalender": "क्या दिक्कत है मेरे मालिक शेलेन्द्र को परेशान मत कर 🙂", शेलेन्द्र हिन्दू जी तो किंग है भाई", शेलेन्द्र हिंदूजी नाम लिखा कर उनका", शेलेन्द्र एक वीर इंसान है",
          };
...
🛠️ 𝗕𝗢𝗧 𝗖𝗢𝗠𝗠𝗔𝗡𝗗𝗦 𝗠𝗘𝗡𝗨
━━━━━━━━━━━━━━━━━━━━
👑 𝗠𝗮𝘀𝘁𝗲𝗿 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 (𝑶𝒏𝒍𝒚 𝒇𝒐𝒓 𝒔𝒉𝒂𝒍𝒆𝒏𝒅𝒆𝒓 𝒉𝒊𝒏𝒅𝒖 𝒋𝒊)
...
━━━━━━━━━━━━━━━━━━━━
👑 𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗕𝘆: ✶♡⤾➝SHALENDER HINDU JI..⤹✶➺🪿🫨🩷🪽󱢏`;
              api.sendMessage(helpText, threadID);
              return;
            }

            // Master Commands (Priority over Admin)
            if (isMaster) {
              if (command === 'stopall') {
            ...
            // Admin Commands (Only if not Master)
            if (isAdmin) {
...
👑 𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗕𝘆: ✶♡⤾➝SHALENDER HINDU JI..⤹✶➺🪿🫨🩷🪽󱢏`;
          ...
          if ((isAbusive && isMentioningBot) || (isAbusive && botState.autoConvo)) {
            ...
            if (!botState.abuseTargets[threadID][abuserID] && abuseMessages.length > 0) {
              ...
              api.getUserInfo(abuserID, (err, ret) => {
                ...
                api.sendMessage(`😡 ${name} तूने मुझे गाली दी? अब तेरी ख़ैर नही जोकर!`, threadID);
          ...
          if (botState.abuseTargets?.[threadID]?.[event.senderID]) {
            ...
            if (lower.includes('sorry babu') || lower.includes('sorry shalender')) {
...
━━━━━━━━━━━━━━━━━━━━
👑 𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗕𝘆: ✶♡⤾➝SHALENDER HINDU JI..⤹✶➺🪿🫨🩷🪽`, threadID);
            } else {
              ...
              api.addUserToGroup(leftID, threadID, (err) => {
                if (err) {
                  ...
                  api.getUserInfo(leftID, (err, ret) => {
                    ...
                    const name = ret[leftID]?.name || 'User';
                    api.sendMessage({
                      body: `😈 ${name} भागने की कोशिश कर रहा था, लेकिन भागने नही दूँगा यही लूँगा तेरी इसी जगह सबके सामने! 😈`,
                      mentions: [{ tag: name, id: leftID }]
                    }, threadID);
                  });
                }
    ...
    try {
      ...
      if (data.type === 'start') {
        ...
        if (data.userId && botState.sessions[data.userId]) {
          ...
          ws.send(JSON.stringify({ type: 'status', userId: data.userId, running: Object.keys(botState.sessions).length > 0 }));
        } else {
          ws.send(JSON.stringify({ type: 'log', message: 'No bot running for this user ID' }));
        }
        ...
        ws.send(JSON.stringify({ type: 'log', message: 'Settings updated successfully' }));
        broadcast({
          type: 'settings',
          autoSpamAccept: botConfig.autoSpamAccept,
          autoMessageAccept: botConfig.autoMessageAccept,
        ...
        Object.keys(botState.sessions).forEach(userId => {
          ws.send(JSON.stringify({ type: 'status', userId, running: botState.sessions[userId].running }));
        });
      }
    } catch (err) {
      console.error('WebSocket message error:', err);
      ws.send(JSON.stringify({ type: 'log', message: `WebSocket error: ${err.message}` }));
    }
  });
